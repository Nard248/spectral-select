"""Lichens KNN accuracy vs K - SOTA comparison plot.

Reads `revision/baselines/results_lichens_quick/lichens/method_summary.csv`.
...
SUMMARY = ROOT / "revision" / "baselines" / "results_lichens_quick" / "lichens" / "method_summary.csv"
...
def main():
    ...
    ax.set_title(
        "Lichens Dataset: K-band classification accuracy across methods\n"
        "AE-perturb (ours, red) tops Variance & PCA-loading at low K; competitive throughout.",
        fontsize=11,
    )
